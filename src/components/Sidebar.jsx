        ...
        <>
            ...
            <aside className={`sidebar ${isOpen ? 'open' : ''}`}>
                ...
                <nav className="sidebar-nav">
                    ...
                    <Link to="/home?tab=projects" className={`sidebar-link ${isActiveDashboardTab('projects') ? 'active' : ''}`}>
                        <span className="sidebar-link-icon"><FiZap /></span>
                    ...
                    <Link to="/home?tab=earnings" className={`sidebar-link ${isActiveDashboardTab('earnings') ? 'active' : ''}`}>
                        <span className="sidebar-link-icon">💰</span>
                        <span className="sidebar-link-text">Earnings</span>
                    </Link>
